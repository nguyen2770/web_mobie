...
const CardFilterCalibrationWork = ({
  open,
  onClose,
  onSearch,
  onReFeshFilter,
      ...
      >
        <Form className="search-form" form={filterForm} layout="vertical">
          ...
          >
            ...
            />
            <span style={{ flex: 1 }}>
              {t("preventiveSchedule.filter.title")}
            </span>
          </div>
            ...
            <Row>
              <Col span={24}>
                ...
                >
                  <Input
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.code"
                    )}
                  />
                </Form.Item>
              </Col>
              <Col span={24}>
                ...
                >
                  <Input
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.preventive_name"
                    )}
                  />
                </Form.Item>
              </Col>
              <Col span={24}>
                ...
                >
                  <Input
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.serial"
                    )}
                  />
                </Form.Item>
              </Col>
              <Col span={24}>
                ...
                >
                  <Input
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.model"
                    )}
                  />
                </Form.Item>
              </Col>
              <Col span={24}>
                ...
                >
                  <Select
                    ...
                    allowClear
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.status"
                    )}
                    options={(calibrationWorkStatus.Options || []).map(
                      (item) => ({
                        value: item.value,
                        label: t(item.label),
                      })
              ...
              <Col span={24}>
                ...
                >
                  <Select
                    allowClear
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.asset_style"
                    )}
              ...
              <Col span={24}>
                ...
                >
                  <DatePicker
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.start_date"
                    )}
                    format={FORMAT_DATE}
                    style={{ width: "100%" }}
                    allowClear
              ...
              <Col span={24}>
                ...
                >
                  <DatePicker
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.end_date"
                    )}
                    format={FORMAT_DATE}
                    style={{ width: "100%" }}
                    allowClear
              ...
              <Col span={24}>
                ...
                >
                  <Select
                    ...
                    allowClear
                    placeholder={t(
                      "preventiveSchedule.filter.placeholders.priority"
                    )}
...
export default CardFilterCalibrationWork;
