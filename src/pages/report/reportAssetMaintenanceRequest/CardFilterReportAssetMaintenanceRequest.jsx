...
import { Row, Col, Form, Button, DatePicker, Divider, Drawer } from 'antd';
import { ArrowLeftOutlined } from '@ant-design/icons';
import { FORMAT_DATE } from '../../../utils/constant';
import dayjs from 'dayjs';
import { useTranslation } from "react-i18next";

const CardFilterReportAssetMaintenanceRequest = ({ open, onClose, onSearch, onReFeshFilter, valueFilter }) => {
      ...
      >
        ...
        >
          ...
          <div style={{ padding: 16, background: '#fff' }}>
            <Row>
              <Divider>{t("report.common.labels.select_date_incident")}</Divider>
              <Col span={24}>
                <Form.Item
...
export default CardFilterReportAssetMaintenanceRequest;