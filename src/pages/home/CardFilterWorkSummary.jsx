...
import { FORMAT_DATE, jobSummaryType } from '../../utils/constant';
import { priorityType, schedulePreventiveTaskAssignUserStatus } from '../../utils/schedulePreventive.constant';
import { filterOption } from '../../helper/search-select-helper';
import { useTranslation } from 'react-i18next';
import dayjs from "dayjs";

const CardFilterMySchedulePreventive = ({ open, onClose, onSearch, onReFeshFilter }) => {
                ...
                >
                    ...
                    <div style={{ padding: 16, background: '#fff' }}>
                        <Row >
                            ...
                            <Col span={24}>
                                <Form.Item name="jobType" label={t("jobSummary.type_of_work")}>
                                    <Select
                                        showSearch
                                        placeholder={t("jobSummary.select_type_of_work")}
...
export default CardFilterMySchedulePreventive;