...
const CardFilterSchedulePreventive = ({ open, onClose, onSearch, onReFeshFilter }) => {
            ...
            >
                <Form className="search-form" form={filterForm} layout="vertical">
                    ...
                    <div style={{ padding: 16, background: '#fff' }}>
                        <Row>
                            <Col span={24}>
                                <Form.Item label={t("preventiveSchedule.list.search.code")} name="code">
                                    <Input placeholder={t("preventiveSchedule.filter.placeholders.code")} />
                                </Form.Item>
                            </Col>
                            <Col span={24}>
...
export default CardFilterSchedulePreventive;