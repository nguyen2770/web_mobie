...
import { ArrowLeftOutlined, CheckOutlined, CloseOutlined, FilterOutlined, RedoOutlined, SearchOutlined } from "@ant-design/icons";
...
import CardFilterContract from "../calibrationContract/CardFilterContract";
        ...
        <Form className="search-form" form={searchForm} layout="vertical">
            ...
            >
                <ArrowLeftOutlined
                    ...
                    onClick={() => navigate(-1)}
                />
                <span style={{ flex: 1 }}>{t("menu.contract.repair")}</span>
                <FilterOutlined
