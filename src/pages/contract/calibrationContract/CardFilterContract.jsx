...
const CardFilterContract = ({ open, onClose, onSearch, onReFeshFilter }) => {
                    ...
                    <div style={{ padding: 16, background: '#fff' }}>
                        <Row >
                            <Col span={24} className='mb-2'>
                                <Form.Item name="contractNo" label={t("amc.manager.table.contract_no")}>
                                    <Input
...
export default CardFilterContract;