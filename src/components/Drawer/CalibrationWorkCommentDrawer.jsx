...
const CalibrationWorkCommentDrawer = ({ open, onClose, calibrationWork }) => {
            ...
            <Row style={{ textAlign: "center" }}>
              <Col span={12}>
                <div style={{ color: "#aaa", fontSize: 15 }}>
                  {t("preventive.comment.code", { defaultValue: "Mã của thẻ" })}
                </div>
                <div
              ...
              <Col span={12}>
                <div style={{ color: "#aaa", fontSize: 15 }}>
                  {t("preventive.comment.open_date", {
                ...
                <div
                  style={{ color: "#00b96b", fontWeight: 500, fontSize: 17 }}
                >
                  {calibrationWork?.createdAt
                    ? new Date(calibrationWork.createdAt).toLocaleString(
                        "vi-VN"
                      )
                    : "null"}
                </div>
          ...
          >
            <Input.TextArea
              ...
              placeholder={t("preventive.comment.placeholder", {
                defaultValue: "Nhập nội dung bình luận...",
              })}
              onPressEnter={(e) => {
                if (!e.shiftKey) {
                  e.preventDefault();
...
export default React.memo(CalibrationWorkCommentDrawer);
